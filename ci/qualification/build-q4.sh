...
sha256sum build/DF build/DU build/Find | tee "$out/checksums.sha256"
echo 'PASS: native Q4 build and static startup/dependency checks' | tee "$out/result.txt"
